  ...
  <SafeAreaView style={styles.safeArea}>
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.kagoFrame}>
        ...
        <TouchableOpacity
        style={[styles.button, styles.seletKagoTopButton]}
        onPress={() => {
          NextDept = Dept[0]
        ...
        <TouchableOpacity
        style={[styles.button, styles.seletKagoButton]}
        onPress={() => {
          NextDept = Dept[1]
          //navigation.navigate('Notification',NextDept)
          props.navigation.navigate('通知画面',NextDept,Port); // 遷移先の画面名を指定
        ...
        onPress={() => {
          ...
          <TouchableOpacity
            ...
            onPress={() => {
            NextDept = Dept[0]
            props.navigation.navigate('KagoshimaAll',Port); // 遷移先の画面名を指定
          }}>
